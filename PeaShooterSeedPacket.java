...
/**
 * Defines a PeaShooterSeedPacket object. 
 * 
 * TODO: Obviously this shares much in common with the SunflowerSeedPacket class,
 *       so in the future, I will move the redundant code into the parent class (SeedPacket)
 * 
 * @author bcanada
 * @version 2014.01.17
 */
public class PeaShooterSeedPacket extends SeedPacket
{
    /*
     * TODO: I'm thinking I need a "cost" variable here... currently
     * this is implemented elsewhere in the project
     */
    private GreenfootImage imgReady     = new GreenfootImage("SeedPacket_Peashooter.png");
    private GreenfootImage imgSelected  = new GreenfootImage("SeedPacket_Peashooter_selected.png");
     ...
     */
    public PeaShooterSeedPacket()
    {
        setImage( imgReady );
    } // end PeaShooterSeedPacket constructor 
    ...
    public void act() 
    {
        ...
        if ( Greenfoot.mouseClicked( this ) ) 
        {
            ...
            myGame.setPeaShooterSeedPacketClickStatus( true );
...
} // end class PeashooterSeedPacket
